...
export default function MigrateFromSimproPage() {
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", maxWidth: 740, margin: "0 auto", padding: "48px 24px" }}>
      ...
      {/* Pricing comparison */}
      <section style={{ marginBottom: 36, background: "#171717", borderRadius: 12, padding: "20px 24px" }}>
        <h2 style={{ fontSize: 16, fontWeight: 700, color: "#ffffff", marginBottom: 12 }}>
          Pricing comparison
        </h2>
        <p style={{ color: "#d4d4d4", fontSize: 14, lineHeight: 1.7, margin: 0 }}>

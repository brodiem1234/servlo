    ...
    <main style={{ fontFamily: "system-ui, sans-serif", maxWidth: 740, margin: "0 auto", padding: "48px 24px" }}>
      ...
      <section style={{ marginBottom: 36 }}>
        ...
        <p style={{ color: "#64748b", fontSize: 14, marginTop: 12 }}>
          ...
          If you&apos;d like early access, email <a href="mailto:hello@servlo.com.au" style={{ color: "#0891b2" }}>hello@servlo.com.au</a>.
        </p>
      </section>
      ...
      <div style={{ marginTop: 48, borderTop: "1px solid #e2e8f0", paddingTop: 24 }}>
        <p style={{ color: "#94a3b8", fontSize: 13 }}>
          ...
          <Link href="/migrate/from-tradify" style={{ color: "#0891b2" }}>Tradify migration guide</Link>
          {" "}&middot;{" "}

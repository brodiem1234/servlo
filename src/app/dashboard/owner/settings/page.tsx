        ...
        <Card>
          ...
          <form action={updateProfileAction} className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1">
              ...
              <div className="bg-zinc-100 dark:bg-[#161d2e] rounded-md px-3 py-2 text-sm text-[var(--text-primary)] cursor-not-allowed opacity-70">
            ...
            <div className="space-y-1">
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                ...
                <a href="mailto:hello@servlo.com.au" className="text-white hover:underline">
                  hello@servlo.com.au
                </a>
              </p>
            </div>
        ...
        <div className="space-y-5">
          ...
          <Card>
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--text-secondary)]">
                  Give clients a public booking page and embeddable widget for your website.
                </p>
              </div>
              <a
          ...
          <Card>
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--text-secondary)]">
                  Automatically send email or SMS messages to clients when a job reaches a certain status.
                </p>
              </div>
              <a
          ...
          <Card>
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--text-secondary)]">
                  Configure automated SMS reminders for jobs, invoices and quotes using Twilio.
                </p>
              </div>
              <a
          ...
          <Card>
            ...
            <form action={updateWorkspaceFeaturesAction} className="mt-4">
                        ...
                        label={
                          <span className="flex flex-wrap items-center gap-2">
                            ...
                            {isRecommendedFeatureForIndustry(id, primaryIndustry) ? (
                              <span className="rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white">Recommended</span>
                            ) : null}
                          </span>
                        }
              ...
              <div className="sticky bottom-0 border-t border-zinc-200 dark:border-white/10 bg-white dark:bg-[#1a2235] p-4 -mx-6 -mb-6">
                <button
                  type="submit"
                  className="rounded-md bg-[var(--product-accent)] px-5 py-2 text-sm font-semibold text-white hover:bg-[var(--brand-accent-hover)]"
                >

  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[var(--text-secondary)]">Track your scheduled jobs, quotes, and invoices.</p>
      </div>

      <div className="grid gap-4 sm:grid-cols-3">
        <article className="rounded-xl border-l-4 border-l-[var(--accent-color)] border bg-white p-4 shadow-sm">
          <p className="text-xs uppercase text-[var(--text-secondary)]">My jobs</p>
          <p className="mt-1 text-2xl font-bold text-[var(--text-primary)]">{jobs?.length ?? 0}</p>
        </article>
        <article className="rounded-xl border-l-4 border-l-[var(--accent-color)] border bg-white p-4 shadow-sm">
          <p className="text-xs uppercase text-[var(--text-secondary)]">Quotes</p>
          <p className="mt-1 text-2xl font-bold text-[var(--text-primary)]">{quotes?.length ?? 0}</p>
        </article>
        <article className="rounded-xl border-l-4 border-l-[var(--accent-color)] border bg-white p-4 shadow-sm">
          <p className="text-xs uppercase text-[var(--text-secondary)]">Invoices</p>
          <p className="mt-1 text-2xl font-bold text-[var(--text-primary)]">{invoices?.length ?? 0}</p>
        </article>
      </div>

      <div className="grid gap-4 xl:grid-cols-3">
        <article className="rounded-xl border bg-white p-4 shadow-sm xl:col-span-1">
          <h2 className="text-lg font-semibold text-[var(--text-primary)]">My Jobs</h2>
          <div className="mt-3 space-y-2 text-sm">
            ...
            {(jobs ?? []).length === 0 ? <p className="text-[var(--text-secondary)]">No jobs assigned yet.</p> : null}
          </div>
        </article>

        <article className="rounded-xl border bg-white p-4 shadow-sm xl:col-span-1">
          <h2 className="text-lg font-semibold text-[var(--text-primary)]">My Quotes</h2>
          <div className="mt-3 space-y-2 text-sm">
            ...
            {(quotes ?? []).length === 0 ? <p className="text-[var(--text-secondary)]">No quotes yet.</p> : null}
          </div>
        </article>

        <article className="rounded-xl border bg-white p-4 shadow-sm xl:col-span-1">
          <h2 className="text-lg font-semibold text-[var(--text-primary)]">My Invoices</h2>
          <div className="mt-3 space-y-2 text-sm">
            ...
            {(invoices ?? []).length === 0 ? <p className="text-[var(--text-secondary)]">No invoices yet.</p> : null}
          </div>
        </article>
      </div>
    </section>

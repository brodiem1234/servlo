...
export default function LeadsBrowsePage() {
  return (
    <section className="space-y-5">
      ...
      >
        ...
        <p className="mt-3 max-w-sm text-sm" style={{ color: "var(--text-muted)" }}>
          Browse verified leads filtered by industry, suburb and job type. Buy only the leads that match your
          business — from $12 per lead with a quality guarantee.
        </p>
      </div>
    </section>
  );

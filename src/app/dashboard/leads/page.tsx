import { Zap, ShoppingBag, ClipboardList, TrendingUp } from "lucide-react";

const STAT_CARDS = [
  { label: "Available Leads", value: "—", Icon: ShoppingBag },
  { label: "My Leads", value: "—", Icon: ClipboardList },
    ...
    <section className="space-y-6">
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold" style={{ color: "var(--text-primary)" }}>
          SERVLO Leads — coming soon
        </h2>
        <p className="mt-2 max-w-sm text-sm" style={{ color: "var(--text-muted)" }}>
          Browse a marketplace of verified, industry-matched leads. Pay only for the leads you want —
          no subscription, no fluff. Launching Q4 2026.
        </p>
      </div>
    </section>
  );

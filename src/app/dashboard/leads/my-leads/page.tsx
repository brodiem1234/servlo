...
export default function LeadsMyLeadsPage() {
  return (
    <section className="space-y-5">
      ...
      >
        ...
        >
          <ClipboardList size={32} style={{ color: "var(--accent-color)" }} />
        </span>
        ...
        <p className="mt-3 max-w-sm text-sm" style={{ color: "var(--text-muted)" }}>
          All the leads you&apos;ve purchased, in one place. Track contact status, follow-up notes and
          conversion — fully integrated with your Core client list.
        </p>
      </div>
    </section>
  );

...
function RequestReviewModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="w-full max-w-md rounded-2xl border bg-white dark:bg-[#1a2235] p-6 shadow-2xl"
            ...
            <div>
              ...
              {loadingJobs ? (
                ...
                <select
                  ...
                  className="w-full rounded-lg border bg-white dark:bg-[#161d2e] px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-purple-500/50"
...
export default function ReviewHubClient({
  ...
  return (
    <section className="space-y-6">
      ...
      <dialog
        ref={dialogRef}
        className="rounded-2xl border bg-white dark:bg-[#1a2235] p-6 shadow-2xl backdrop:bg-black/60"
        style={{
          borderColor: "var(--border)",
          color: "var(--text-primary)",
          maxWidth: "400px",

...
const FLEET_LOGO_FILTER =
  "brightness(0) saturate(100%) invert(1) sepia(1) saturate(4) hue-rotate(180deg)";

type NavItem = { href: string; label: string; Icon: LucideIcon };

const FLEET_NAV: NavItem[] = [
  { href: "/dashboard/fleet", label: "Dashboard", Icon: LayoutDashboard },
  { href: "/dashboard/fleet/vehicles", label: "Vehicles", Icon: Truck },
  { href: "/dashboard/fleet/equipment", label: "Equipment", Icon: Wrench },
  { href: "/dashboard/fleet/jobs", label: "Jobs", Icon: ClipboardList },
  { href: "/dashboard/fleet/tracking", label: "Tracking", Icon: MapPin },
];

function isActive(pathname: string, href: string) {
  if (href === "/dashboard/fleet") return pathname === "/dashboard/fleet";
      ...
      >
        ...
        <div className="mb-4 flex flex-col items-center">
          <Image
            ...
            width={120}
            height={120}
            style={{ height: "auto", maxWidth: "120px", filter: FLEET_LOGO_FILTER }}
          />
          <div
        ...
        {/* Product switcher */}
        <div className="mb-4">
          <ProductSwitcher activeProduct="fleet" />
        </div>

...
const BOOKS_LOGO_FILTER =
  "brightness(0) saturate(100%) invert(1) sepia(1) saturate(4) hue-rotate(90deg) brightness(0.9)";
      ...
      >
        ...
        <div className="mb-4 flex flex-col items-center">
          <Image
            ...
            width={120}
            height={120}
            style={{ height: "auto", maxWidth: "120px", filter: BOOKS_LOGO_FILTER }}
          />
          <div

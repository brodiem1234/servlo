...
import { Rss, Search, MessageSquare, User, Users, Briefcase, Menu, X as XIcon, Compass, HelpCircle, LayoutGrid } from "lucide-react";
    ...
    >
      ...
      >
        <div className="grid grid-cols-5 px-2">
          {CONNECT_NAV.slice(0, 4).map((item) => {
            const active = isActive(pathname, item.href);
            return (
              <a
                key={item.href}

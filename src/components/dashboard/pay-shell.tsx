...
const PAY_NAV: NavItem[] = [
  { href: "/dashboard/pay", label: "Dashboard", Icon: LayoutDashboard },
  {
    href: "/dashboard/pay/transactions",
    label: "Transactions",
    Icon: ArrowLeftRight,
  },
  { href: "/dashboard/pay/payouts", label: "Payouts", Icon: Banknote },
  { href: "/dashboard/pay/settings", label: "Settings", Icon: Settings2 },
  { href: "/dashboard/pay/rates", label: "Rates", Icon: BarChart2 },
];

function isActive(pathname: string, href: string) {
  if (href === "/dashboard/pay") return pathname === "/dashboard/pay";
  return pathname === href || pathname.startsWith(`${href}/`);
}

export default function PayShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Product switcher */}
        <div className="mb-4">
          <ProductSwitcher activeProduct="pay" />
        </div>

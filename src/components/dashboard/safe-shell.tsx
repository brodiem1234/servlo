...
const SAFE_NAV: NavItem[] = [
  { href: "/dashboard/safe", label: "Dashboard", Icon: LayoutDashboard },
  { href: "/dashboard/safe/incidents", label: "Incidents", Icon: AlertTriangle },
  { href: "/dashboard/safe/toolbox", label: "Toolbox Talks", Icon: BookOpen },
  { href: "/dashboard/safe/compliance", label: "Compliance", Icon: ShieldCheck },
];

function isActive(pathname: string, href: string) {
  if (href === "/dashboard/safe") return pathname === "/dashboard/safe";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Product switcher */}
        <div className="mb-4">
          <ProductSwitcher activeProduct="safe" />
        </div>

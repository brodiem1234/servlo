...
function isActive(pathname: string, href: string) {
  if (href === "/dashboard/insurance")
    return pathname === "/dashboard/insurance";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Product switcher */}
        <div className="mb-4">
          <ProductSwitcher activeProduct="insurance" />
        </div>

        {/* Nav */}
        <nav className="flex flex-col gap-0">
          <div className="flex flex-col gap-2">
            {INSURANCE_NAV.map((item) => {
        ...
        <div className="mt-auto">
          ...
          >
            ...
            >
              SERVLO Insurance launches Q4 2027
            </p>
          </div>
        </div>
      </aside>
      ...
      >
        <div className="grid grid-cols-5 px-2">
          {INSURANCE_NAV.slice(0, 4).map((item) => {
            const active = isActive(pathname, item.href);
            return (
              <a
                key={item.href}

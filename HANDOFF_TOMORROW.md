...
- `/docs/` folder — user-facing documentation pages
- HIRE ATS kanban drag-drop
- FLEET GPS integration stub
- Apply pending DB migrations via Supabase SQL editor

_Generated by Claude — overnight build session 2026-05-10 (continued)_
